...
import { User, BookOpen, TestTube, Video, Library, TrendingUp, Users, Calendar, Settings } from 'lucide-react'
          ...
          <ScrollReveal direction="up" delay={0.3}>
            <div className="p-6 rounded-xl border bg-card border-border">
              ...
              <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
                {[
                  { title: 'Study Materials', icon: BookOpen, href: '/study', color: 'text-blue-500', bgColor: 'bg-blue-500/10' },
                  { title: 'Practice Tests', icon: TestTube, href: '/tests', color: 'text-purple-500', bgColor: 'bg-purple-500/10' },
                  { title: 'Video Lessons', icon: Video, href: '/videos', color: 'text-red-500', bgColor: 'bg-red-500/10' },
                  { title: 'Library', icon: Library, href: '/library', color: 'text-green-500', bgColor: 'bg-green-500/10' }
                ].map((action, index) => (
                  <MotionWrapper key={action.title} animation="scale" delay={0.1 * index}>
                    ...
                    >
                      ...
                      <span className="mt-2 text-sm font-medium text-center text-foreground">{action.title}</span>
                    </Link>
                  </MotionWrapper>
                ))}
              </div>
