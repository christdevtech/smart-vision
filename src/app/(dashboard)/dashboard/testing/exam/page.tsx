...
export default async function ExamPage() {
  ...
  return (
    <DashboardLayout user={user} title="Exam Mode">
        ...
        <div className="container px-4 py-6 mx-auto space-y-8">
          <MotionWrapper animation="fadeIn" delay={0.1}>
            <div className="p-6 bg-gradient-to-r to-transparent rounded-2xl border from-primary/10 via-primary/5 border-border/50">
              <div className="flex gap-4 items-center">
                ...
                <div>
                  <h1 className="mb-2 text-3xl font-bold text-foreground">Exam Mode</h1>
                  <p className="text-lg text-muted-foreground">Timed MCQ tests</p>
                </div>
              </div>
            </div>
          </MotionWrapper>
          ...
          <MotionWrapper animation="fadeIn" delay={0.2}>
            <div className="p-6 rounded-2xl border bg-card border-border/50">
              <p className="text-muted-foreground">Exam interface will be available here.</p>
            </div>
          </MotionWrapper>
        </div>
      </div>
